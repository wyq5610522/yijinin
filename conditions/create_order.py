...
time.sleep(2)
##方向买入
url_1 = "http://api2.quote-dev-1.bybit.com/v3/private/order/create"
data={"orderType":"Limit","side":"Buy","timeInForce":"GoodTillCancel","qtyX":"10","tpTriggerBy":"LastPrice",
...
rep = requests.post(url=url_1,json=data,headers=headers)
print(rep.json())